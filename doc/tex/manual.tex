...
\end{verbatim}
          ...
          \item[Version 2.08.00 (Aug-2014)] Usability and Validation Changes
          	...
          	\end{enumerate}
		\item[Version 2.08.01 (TBD)] Minor Changes
			\begin{enumerate}
				\item In shared model mode, SMAC can now reuse an existing run from another run.
				\item Detailed Trajectory File now outputs predicted performance of the incumbent.
				\item Fixed a bug with the LCB acquisition function usage.
			\end{enumerate}
