...
\end{verbatim}
			...
			\item[Version 2.06.01 (Oct-2013)] Minor Bug Fix of Java SMAC
	              \begin{enumerate}
                     ...
                     \item If SMAC is shutting down for an unexpected reason (e.g. \texttt{OutOfMemoryError} ,or itreceived a \texttt{SIGTERM}), SMAC will now try its best to write a final batch of state data with the "SHUTDOWN" prefix. \\
