...
\end{verbatim}
          ...
          \item[Version 2.06.02 (Mar-2014)] Minor Bug Fix Release of Java SMAC
          	\begin{enumerate}
          		...
          		\item New option \textbf{-$~\!$-no-instances} will use a dummy instance instead of the instance file (useful for black box optimization).
