...
\end{verbatim}
	...
	\item[Version 2.10.03 (July-2015)] Simple Bug Fix
		...
		\end{enumerate}
	\item[Version 2.10.04 (December-2015)] Bug Fix
		\begin{enumerate} 
			\item Fixed performance regression in highly conditional spaces introduced in SMAC v2.10.00.
			\item \textbf{-$~\!$-mask-inactive-conditional-parameters-as-default-value} now causes \textbf{-$~\!$-rf-ignore-conditionality} to default to true.
		\end{enumerate}
